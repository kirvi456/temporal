...
class MyView2 extends PageViewElement {
  ...
  buscarEsposa(){
    ...
    .then(myJson => {
      ...
      }else if(myJson['matrimonio'] != -1){
        nombre.value    = 'Persona esta casada.';
        apellido.value  = 'Persona esta casada.';
      }else{
  ...
  buscarActaNacimiento(){
    ...
    var miInit = { 
      ...
      body: JSON.stringify({
        url: window.urlBaseMatrimonio + '/getMatrimonio',
        tipo: 'POST',
    ...
    .then(myJson => {
      if(myJson.mensaje == "Partida no registrado."){
        alert("Partida de matrimonio no encontrada.");
      }else{
        numeroActa      = myJson['nomatrimonio'] + "";
  ...
  registrar() {
    ...
    if(nombreEsposo == 'No existe persona con ese DPI.' 
      ...
      || nombreEsposo == 'Persona esta casada.'){
    ...
    if(nombreEsposa == 'No existe persona con ese DPI.' 
      ...
      || nombreEsposa == 'Persona esta casada.'){
    ...
    let data = JSON.stringify(
      {     
        url: window.urlBaseMatrimonio + '/setMatrimonio',
        tipo: 'POST',   
        parametros:{
          dpihombre:          dpiEsposo,
    ...
    return html`
     <div id="formulario">
      <div id="marcoAgregar">
        ...
        <div class="lineaform">
          <label class="titulop">Fecha Matrimonio:</label>    
